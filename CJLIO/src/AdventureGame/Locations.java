...
public class Locations implements Map<Integer, Location> {
    ...
    public static void main(String[] args) throws IOException {
        try (FileWriter locFile = new FileWriter("CJLIO/locations.txt");
             FileWriter dirFIle = new FileWriter("CJLIO/directions.txt")) {
...
//        try {
//            locFile = new FileWriter("CJLIO/locations.txt");
//            for(Location location : locations.values()) {
//                locFile.write(location.getLocationID() + ";" + location.getDescription() + "\n");
...
//        }
    ...
    static {
        ...
        try{
            scanner = new Scanner(new FileReader("CJLIO/locations_big.txt"));
        ...
        // Now read the exits
        try {
            scanner = new Scanner(new BufferedReader(new FileReader("CJLIO/directions_big.txt")));
            scanner.useDelimiter(",");
            while (scanner.hasNextLine()) {
//                int loc = scanner.nextInt();
