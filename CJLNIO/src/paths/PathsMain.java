...
/*
Use java.nio when working with a file system and when reading and writing file contents.
...
//        try (DirectoryStream<Path> contents = Files.newDirectoryStream(directory, "*.dat")) {
        ...
        Path copyPath = FileSystems.getDefault().getPath("CJLNIO" + File.separator + "FileTree" +
        ...
        File file = new File("CJLNIO/files/SubdirectoryFile.txt");
        Path convertedPath = file.toPath();
        System.out.println("convertedPath = " + convertedPath);

        File parent = new File("CJLNIO/files");
        File resolvedFile = new File(parent, "dir/file.txt");
        System.out.println(resolvedFile.toPath());

        resolvedFile = new File("CJLNIO/files", "dir/file.txt");
        System.out.println(resolvedFile.toPath());

        Path parentPath = Paths.get("CJLNIO/files");
        ...
        File dir2File = new File(workingDirectory, "CJLNIO/FileTree/Dir2");
