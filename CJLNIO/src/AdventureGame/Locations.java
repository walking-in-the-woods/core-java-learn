...
public class Locations implements Map<Integer, Location> {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path locPath = FileSystems.getDefault().getPath("CJLNIO/locations.dat");
...
//        Path locPath = FileSystems.getDefault().getPath("CJLNIO/locations_big.txt");
//        Path dirPath = FileSystems.getDefault().getPath("CJLNIO/directions_big.txt");
//
